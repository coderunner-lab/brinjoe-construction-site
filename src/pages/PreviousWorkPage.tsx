...
export const projects: Project[] = [
  {
    ...
    coverImage: '/images/portfolio/porch-deck/cover.jpg',
    description:
    ...
    images: [
      { src: '/images/portfolio/porch-deck/1.jpg', alt: 'Porch deck view 1' },
      { src: '/images/portfolio/porch-deck/2.jpg', alt: 'Porch deck view 2' },
      { src: '/images/portfolio/porch-deck/3.jpg', alt: 'Porch deck view 3' },
      { src: '/images/portfolio/porch-deck/4.jpg', alt: 'Porch deck view 4' },
      { src: '/images/portfolio/porch-deck/5.jpg', alt: 'Porch deck view 5' },
      { src: '/images/portfolio/porch-deck/6.jpg', alt: 'Porch deck view 6' },
      { src: '/images/portfolio/porch-deck/7.jpg', alt: 'Porch deck view 7' },
      { src: '/images/portfolio/porch-deck/8.jpg', alt: 'Porch deck view 8' },
      { src: '/images/portfolio/porch-deck/9.jpg', alt: 'Porch deck view 9' },
      { src: '/images/portfolio/porch-deck/10.jpg', alt: 'Porch deck view 10' },
    ],
  },
  {
    slug: 'norcrest',
    ...
    coverImage: '/images/portfolio/norcrest/cover.png',
    description:
    ...
    beforeAfter: true,
    images: [
      { src: '/images/portfolio/norcrest/1.png', alt: 'Room 1 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/2.png', alt: 'Room 1 — After', label: 'After' },
      { src: '/images/portfolio/norcrest/3.png', alt: 'Room 2 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/4.png', alt: 'Room 2 — After', label: 'After' },
      { src: '/images/portfolio/norcrest/5.png', alt: 'Room 3 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/6.png', alt: 'Room 3 — After', label: 'After' },
      { src: '/images/portfolio/norcrest/7.png', alt: 'Room 4 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/8.png', alt: 'Room 4 — After', label: 'After' },
      { src: '/images/portfolio/norcrest/9.png', alt: 'Room 5 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/10.png', alt: 'Room 5 — After', label: 'After' },
      { src: '/images/portfolio/norcrest/11.png', alt: 'Room 6 — Before', label: 'Before' },
      { src: '/images/portfolio/norcrest/12.png', alt: 'Room 6 — After', label: 'After' },
    ],
  },
];
